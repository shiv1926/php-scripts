...
<html>
  <head>
	...
	.first_row { background-image: url('html-images/header.jpg'); padding: 30px 0; text-align: center; background-size: cover; background-repeat: no-repeat; }
	...
	.third_row { padding: 22px 0; text-align: center; background-color: #fff; background-image: url('html-images/footer.jpg'); background-position: center top; background-repeat: no-repeat; background-size: cover; }
...
<?php 
$folder = '3-may-2018';
$inputFileName = $folder.'/product-sheet.xls';
...
foreach($activeData->getRowIterator() as $row)
{
	...
	$data = array();
	$data = @getimagesize($folder."/images/".strtolower($imagename));
	...
	if($title!='' && $data[0]!='')
	{
		...
		echo '<img src="'.$folder.'/images/'.$imagename.'">';
		echo '</div>';
		echo '<div class="third_row">';
		echo '<div class="phone_number">';
		echo '<span class="imgcon"><img src="html-images/phone.png"></span>';
